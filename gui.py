...
def equal():
     ...
     if math == "addition":
          ...
          e.insert(0 , f_num / s_num)
#define buttons
bt1 = Button(root, text = "1", padx = 40 , pady = 20, command = lambda : click(1))#callback #lambda is inbuilt function to evaluate
...
btEquals = Button(root, text = "=", padx = 40 , pady = 51, command = equal)#callback
